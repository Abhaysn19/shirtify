...
const AdminDashboard = () => {
    ...
    return (
      <div className="card mb-4">
        ...
        <ul className="list-group">
          ...
          <li className="list-group-item">
            <span className="badge bg-dark">Admin Area</span>
          </li>
        </ul>
      </div>
    )
  ...
  return (
    <Base title= "Welcome to Admin Panel" description="Manage all of your products here"
    className='= "container bg-success p-5-4'>
    <div className="row">
      <div className="col-3">
        {adminLeftSide()}
      </div>
